...
#dict_of_folders = 'f1':{'title': ['Amazon Shopping'], 'keywords':['Amazon Shopping', 'AMZN Mobile LLC', 'Shopping', 'Lifestyle', 'ios apps', 'app, appstore', 'app store', 'iphone', 'ipad', 'ipod touch', 'itouch', 'itunes'],'cat':['Shopping']},{'f2':{'title':['stuff']}}}
from nltk.corpus import stopwords
#nltk.download('stopwords')
from nltk.tokenize import word_tokenize
import numpy as np
dict_of_folders = {'f1': [{'title': ['Crunchyroll'], 'keywords': ['Crunchyroll', 'Ellation', 'Inc., Entertainment', 'Lifestyle', 'ios apps', 'app, appstore', 'app store', 'iphone', 'ipad', 'ipod touch', 'itouch', 'itunes'], 'cat':['Entertainment']},{'title': ['Amazon Shopping'],'keywords':['Amazon Shopping', 'AMZN Mobile LLC', 'Shopping', 'Lifestyle', 'ios apps', 'app, appstore', 'app store', 'iphone', 'ipad', 'ipod touch', 'itouch', 'itunes'],'cat':['Shopping']}],'f2': [{'title': ['Crunchyroll'], 'keywords': ['Crunchyroll', 'Ellation', 'Inc., Entertainment', 'Lifestyle', 'ios apps', 'app, appstore', 'app store', 'iphone', 'ipad', 'ipod touch', 'itouch', 'itunes'], 'cat':['Entertainment']}], 'f3':[{'title': ['Pimple Popping!'], 'keywords':['Pimple Popping!', 'Voodoo', 'Games', 'ios apps', 'app', 'appstore', 'app store', 'iphone', 'ipad', 'ipod touch', 'itouch', 'itunes'],'cat':['Games']}]}
